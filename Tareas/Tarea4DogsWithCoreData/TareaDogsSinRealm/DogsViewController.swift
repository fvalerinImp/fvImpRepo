...
//    var lstPerros : Results<clsDog>?
    var arrPerrosCoreData = [ClsDogCoreData]()
...
//        lstPerros = RealmManager.ObtenerPerros()
        arrPerrosCoreData = CoreDataManager.getAllPerros()
...
//        viewController.delegado = self
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        //news = categoryType?.news.allObjects as? [News]
        CargarPerros()
...
//        return lperros.count
        ...
        return arrPerrosCoreData.count
    }
...
//        cell.AsignarCelda(pPerro: (lstPerros?[ indexPath.row ])! )
        ...
        cell.AsignarCelda(pPerro: (arrPerrosCoreData[ indexPath.row ]) )
