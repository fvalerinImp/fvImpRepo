//
//  AddDogTableViewController.swift
//  TareaDogsSinRealm
//
...
//protocol clsAddDogProtocol : class {
//    func agregarObjeto( pObjeto: clsDog )
//}

class AddDogTableViewController: UITableViewController {

    @IBOutlet weak var txtNombre: UITextField!
    
    @IBOutlet weak var txtColor: UITextField!
    
//    weak var delegado : clsAddDogProtocol?
...
//        delegado?.agregarObjeto(pObjeto: objeto)
        ...
        CoreDataManager.SalvarUnPerro(pNombre: txtNombre.text!, pColor: txtColor.text!, pImagen: "perro" + sNumero, pOrden: 1)
