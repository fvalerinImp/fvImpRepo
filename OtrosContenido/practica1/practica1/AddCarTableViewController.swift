...
protocol clsAddCarProtocol : class {
...
class AddCarTableViewController: UITableViewController {
    ...
    weak var delegado : clsAddCarProtocol?
    ...
    func salvarObjetoAction() {
        ...
        let objeto = clsCarro(pMarca: txtMarca.text!, pDueno: txtDueno.text!, pColor: txtColor.text!, pAno: Int(txtAno.text!)!)
