...
class DogsTableViewController: UITableViewController {
    ...
    func initializeDataSourceWithDictionary(){
        ...
        let dog1 = [keyName:"Bruno", keyColor:"Negro", keyAge:"2 anos"]
        let dog2 = [keyName:"Brunox", keyColor:"Negro", keyAge:"32 anos"]
        let dog3 = [keyName:"Brunoxx", keyColor:"Blanco", keyAge:"3 anos"]
        let dog4 = [keyName:"Brunoxxx", keyColor:"Negro", keyAge:"2 anos"]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let valuecell = dataSource![ indexPath.row ]
        
        cell.NameLabel.text = (valuecell[keyName] as? String)
        cell.ColorLabel.text = (valuecell[keyColor] as? String)
        cell.AgeLabel.text = (valuecell[keyAge] as? String)
        
        
        //cell.textLabel?.text = (valuecell as? String)
